//  Write a java program to accept a directory name from user and write data of all files along with its name and size of each file
            ...
            if (dobj.exists() && dobj.isDirectory())
            {
                ...
                for (int i = 0; i < fArr.length; i++)
                {
                    if (fArr[i].isFile())
                    {
                        ...
                        String Size = "Size: " + FileSize + " bytes\n";
                        foobj.write(Size.getBytes());
